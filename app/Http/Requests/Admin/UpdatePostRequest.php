...
class UpdatePostRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $post !== null && $this->user() !== null && $this->user()->can('update', $post);
    }
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Boolean casts
        $isFeatured = $this->has('is_featured')
            ? filter_var($this->input('is_featured'), FILTER_VALIDATE_BOOLEAN)
            : false;
        $isPublished = $this->has('is_published')
            ? filter_var($this->input('is_published'), FILTER_VALIDATE_BOOLEAN)
            : false;
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['nullable', 'string', 'max:600', Rule::unique('posts', 'slug')->ignore($postId)],
