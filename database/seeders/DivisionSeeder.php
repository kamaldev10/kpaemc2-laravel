    ...
    public function run(): void
    {
        $divisions = [
            [
                ...
                'short_description' => 'Bertanggung jawab atas regenerasi organisasi, proses rekrutmen, Pendidikan dan Latihan Dasar (DIKLATSAR), serta pembinaan mental dan karakter anggota.',
                'full_description' => 'Divisi Kaderisasi merupakan jantung regenerasi KPA EMC². Divisi ini merancang dan mengawal seluruh tahapan kaderisasi mulai dari sosialisasi, bimbingan fisik dan mental, materi dasar kepecintaalaman, DIKLATSAR, hingga pemantapan anggota muda menuju jenjang anggota penuh.',
                'study_materials' => ['Manajemen Organisasi & Kepemimpinan', 'Etika & Kode Etik Pecinta Alam', 'Kurikulum DIKLATSAR', 'Pembinaan Karakter & Mental'],
                'equipment' => ['Buku Panduan Kaderisasi', 'Modul Diklat Lapangan', 'Perlengkapan Simulasi Lapangan'],
                'sort_order' => 1,
                'is_active' => true,
            ],
            [
            ...
            [
                ...
                'full_description' => 'Divisi Penelitian dan Pengembangan (Litbang) bertugas meningkatkan kapasitas intelektual dan teknis organisasi. Mencakup riset lapangan saat ekspedisi (flora, fauna, geomorfologi, hidrologi), pengujian kelayakan alat outdoor, pemetaan digital/GIS, penerbitan jurnal penjelajahan, serta evaluasi berkala kinerja organisasi.',
                'study_materials' => ['Metodologi Penelitian Lapangan & GIS', 'Analisis Kelayakan & Pengujian Alat Outdoor', 'Penyusunan Jurnal & Dokumentasi Ilmiah', 'Evaluasi Strategis Organisasi'],
                'equipment' => ['GPS Tracker & Kompas Geologi', 'Perangkat Lunak Pemetaan (GIS/QGIS)', 'Kamera Trap & Sensor Lapangan', 'Arsip Riset & Jurnal Ekspedisi'],
                'sort_order' => 3,
                'is_active' => true,
            ],
            [
