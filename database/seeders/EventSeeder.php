...
class EventSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $events = [
            ...
            [
                'title' => 'Penerimaan Anggota Muda (DIKLATSAR) KPA EMC² XXXVIII',
                ...
                'type' => 'recruitment',
                'description' => 'Pendidikan dan Latihan Dasar (DIKLATSAR) XXXVIII yang dikoordinasikan oleh Divisi Kaderisasi untuk membentuk calon anggota pecinta alam yang berkarakter, mandiri, dan tangguh.',
                ...
                'location' => 'Sekretariat KPA EMC² & Gunung Salak',
                ...
                'tags' => ['diklatsar', 'kaderisasi', 'recruitment', 'anggota-baru', 'kpa-emc2'],
                'is_published' => true,
                'is_active' => true,
            ],
        ];
